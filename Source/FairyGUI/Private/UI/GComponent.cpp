	...
	AlignOffset(ForceInit)
{
	...
	{
		DisplayObject = RootContainer = SNew(SContainer).GObject(this).Visibility(EVisibility::SelfHitTestInvisible);
		Container = SNew(SContainer).Visibility(EVisibility::SelfHitTestInvisible);
